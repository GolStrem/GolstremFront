...
function switchColor(theme) {
  ...
  document.documentElement.style.setProperty("--color-story", theme === 'dark' ? '#131313ff' : '#f0f0f0');
  document.documentElement.style.setProperty("--color-story-select", theme === 'dark' ? '#2c2c2c' : '#f0f0f0');
